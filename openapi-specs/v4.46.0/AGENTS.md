# AI Agent Quick Reference - GitBucket 4.46.0
...
### Code Comments Identified (Pre-existing, Not New in 4.46.0)
...
### 4.46.0 (Current)
- **No API changes** from 4.45.0
- UI-only release: all API endpoints remain identical to 4.45.0
