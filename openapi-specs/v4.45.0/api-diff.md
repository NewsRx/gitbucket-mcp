# API Differences: GitBucket 4.44.0 → 4.45.0

**Version:** 4.45.0  
**Release Date:** 2026-01-10  
**Upstream Release Notes:** https://github.com/gitbucket/gitbucket/releases/tag/4.45.0

---

## Executive Summary

**No API changes detected between 4.44.0 and 4.45.0.**
...
These are **long-standing issues**, not introduced in 4.45.0.
...
**Source:** Direct code comparison between release tags `4.44.0` and `4.45.0`